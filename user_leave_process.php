...
<?php
	require("includes/connect.php");
			...
			$stmt = $con->prepare("INSERT INTO leavenote (roomno, firstname, email, phone, fdate, tdate, reason) VALUES (?, ?, ?, ?, ?, ?, ?)");
			$stmt->bind_param("sssssss", $roomno, $firstname, $email, $phone, $fdate, $tdate, $reason);
			$stmt->execute();
