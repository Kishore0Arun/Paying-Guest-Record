<?php
	...
	$q = $con->prepare("SELECT * FROM `customer` where status=?");						
									...
									<tr>
										...
										<td class="cart-product-price">
											<div class="row center">
												<a class="button small" href="admin_request_reply1.php?cid=<?php echo $cid;?>"><span>Select</span> </a>
											</div>
										</td>
										<td class="cart-product-quantity">	
											<div class="row center">
												<a class="button small" href="admin_request_reply2.php?cid=<?php echo $cid; ?>"><span>Select</span> </a>
											</div>
										</td>
									</tr>
									<?php
